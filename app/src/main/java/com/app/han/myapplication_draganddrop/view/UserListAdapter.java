...
public class UserListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements SwipeAndDragHelper.ActionCompletionContract {
...
//            ((UserViewHolder) holder).reorderView.setOnLongClickListener(new View.OnLongClickListener() {
//                @Override
